...
```sh
curl -fsSL https://github.com/goldengateagent/grok-models/raw/v2.0.0/install.sh | bash
```

Windows (PowerShell):

```powershell
irm https://github.com/goldengateagent/grok-models/raw/v2.0.0/install.ps1 | iex
```
